...
/**
 * A class which allows for automatically parsing a distribution implementation
 * and generate
 * a class inheriting from Generator accordingly. Use the return type to
 * implements either
 * DiscreteGenerator or ContinuousGenerator. Prompt the user to specify
...
public class MetaGenerator {
	...
	public boolean generate(PrintWriter pw, java.lang.reflect.Method m) {
		...
		for (int i = 0; i < ps.length; i++) {
			...
			paramT.append(ps[i].getName());
			paramT.append(" ");
			paramT.append(params[i]);
